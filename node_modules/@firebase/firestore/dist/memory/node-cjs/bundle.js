...
function loadBundle(data) {
    return databaseEd0bcada.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return databaseEd0bcada.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new databaseEd0bcada.Query(this, 
...
registerBundle(databaseEd0bcada.Firestore);
