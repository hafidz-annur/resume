 ...
 */ function D(t) {
    ...
    if (N.logLevel <= d.DEBUG) {
        var i = e.map(C);
        N.debug.apply(N, r([ "Firestore (8.10.0): " + t ], i));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= d.ERROR) {
        var i = e.map(C);
        N.error.apply(N, r([ "Firestore (8.10.0): " + t ], i));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= d.WARN) {
        var i = e.map(C);
        N.warn.apply(N, r([ "Firestore (8.10.0): " + t ], i));
    }
}
...
var Dt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new kt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Ot(t, r) : "in" /* IN */ === e ? new Pt(t, r) : "not-in" /* NOT_IN */ === e ? new Vt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ft(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
...
/** A mutation that deletes the document at the given key. */ var Ve, Fe, Me = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (Fe = Ve || (Ve = {}))[Fe.OK = 0] = "OK", Fe[Fe.CANCELLED = 1] = "CANCELLED", 
 ...
 * queue.
 */ function fr(t, e) {
    var n = P(t), r = e.snapshotVersion, i = n.kn;
...
function vr(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = P(t), o = e.kn.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 5:
                return e.kn = e.kn.remove(r), e.Fn.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function mr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = P(t), i = r.Fn.get(n);
            return void 0 !== i ? Qn.resolve(r.kn.get(i)) : r.qe.getTargetData(e, n);
...
var Cr = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Fi = function(t, e, n, r) {
        ...
        this.useFetchStreams && (l.xmlHttpFactory = new w({})), this.ki(l.initMessageHeaders, e), 
        ...
        var d = r.createWebChannel(f, l), p = !1, y = !1, v = new Fr({
            Ei: function(t) {
...
function ai(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = P(t), r = mi(e), i = e.Fr.length > 0 ? e.Fr[e.Fr.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                return null === (o = n.sent()) ? (0 === e.Fr.length && r.ir(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Fr.push(e);
                    var n = mi(t);
...
function ci(t) {
    return ei(t) && !mi(t).tr() && t.Fr.length > 0;
}
...
function fi(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = mi(t), r = 0, i = t.Fr; r < i.length; r++) o = i[r], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function di(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.Fr.shift(), o = Hn.from(e, r, i), [ 4 /*yield*/ , ui(t, (function() {
                ...
                return r && mi(t).pr ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return qe(i = r.code) && i !== I.ABORTED ? (e = t.Fr.shift(), 
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    e.sent(), t.Fr.length > 0 && (D("RemoteStore", "Stopping write stream with " + t.Fr.length + " pending writes"), 
                    t.Fr = []), e.label = 4;
...
n) {
    ...
    r, i, o) {
        ...
        this.ko = new Map, this.Fo = tr.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                return -1 === (i = n.sent()) ? [ 2 /*return*/ , void r.resolve() ] : ((o = e.ko.get(i) || []).push(r), 
                e.ko.set(i, o), [ 3 /*break*/ , 4 ]);
...
function eo(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Vi ? (t.No.addReference(o.key, e), no(t, o)) : o instanceof Fi ? (D("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function ro(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new ot(Q.fromString(e)), r = t.Fo.next();
                    ...
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 4:
                                for (o = 0, s = r; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = e.kn.get(a), 
                                h = c.snapshotVersion, l = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                e.kn = e.kn.insert(a, l));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
...
function(t, e, n, r, i, o, s, u) {
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Vo(this.hc, this.lc, this.fc));
        ...
        this._settings = new Qo(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new Fo(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */ function Jo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), Mo("doc", "path", e), t instanceof zo) return qo(n = Q.fromString.apply(Q, r([ e ], i))), 
    new Wo(t, 
...
/** A "context" object passed around while parsing user data. */ var ys = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.xc = function(e) {
        ...
        return Vs(t, this.settings.methodName, this.settings.Bc || !1, this.path, this.settings.qc);
    }, 
...
/** Parse update data from a list of field/value arguments. */ function Ns(t, e, n, r, i, o) {
    ...
    for (var l = [], f = bt.empty(), d = u.length - 1; d >= 0; --d) if (!Fs(l, u[d])) {
        var p = u[d], y = a[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = h(y);
 ...
 * evaluated.
 */ function Ps(t, e, n) {
    if (e.search(Os) >= 0) throw Vs("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (us.bind.apply(us, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw Vs("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, o), {
                ...
                var s, u;
                if ("string" == typeof r.mockUserToken) s = r.mockUserToken, u = Rr.MOCK_USER; else {
                    // Let createMockUserToken validate first (catches common mistakes like
                    // invalid field "uid" and missing field "sub" / "user_id".)
                    s = l(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
                    var a = r.mockUserToken.sub || r.mockUserToken.user_id;
                    if (!a) throw new A(I.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
                    u = new Rr(a);
                }
                t._credentials = new Oo(new Co(s, u));
            }
 ...
 */;
        ...
        try {
            return new Vu(this, Xo(this._delegate, t));
        } catch (t) {
...
var Nu = /** @class */ function() {
    ...
    return t.iu = function(e, n, r) {
        ...
        get: function() {
            return new Vu(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        ...
        try {
            return new Vu(this.firestore, Xo(this._delegate, t));
        } catch (t) {
...
export { wu as B, hs as C, rs as E, x as M, Eu as Q, is as T, bu as U, Iu as W, Ru as X, Cu as Z, mu as a, xu as c, Tu as j, Pu as n, Uu as o, Mu as r, Vu as s, Lu as t, qu as u, Nu as z };
//# sourceMappingURL=prebuilt-5d8cd97c-2f1be13a.js.map
