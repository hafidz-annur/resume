...
class Ct extends class {} {
    ...
    static l(t, e, n) {
        return "in" /* IN */ === e ? new kt(t, n) : new Ft(t, n);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class Ft extends Ct {
    constructor(t, e) {
 ...
 */ (t, e, n) : t instanceof Oe ? function(t, e, n) {
        ...
        i.setAll(Me(t)), i.setAll(s), e.convertToFoundDocument(Fe(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ class Ms {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && O(this.mutations, t.mutations, ((t, e) => ke(t, e))) && O(this.baseMutations, t.baseMutations, ((t, e) => ke(t, e)));
    }
}
 ...
 */
     ...
     */    start() {
        ...
        return this.je().then((() => {
            ...
            throw new R(A.FAILED_PRECONDITION, Fi);
    ...
    dn(t) {
        return Oi(t).get(cs.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new R(A.FAILED_PRECONDITION, Fi);
        }));
    }
    /**
...
async function Zi(t, e, n) {
    const s = x(t), i = s.kn.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
...
// PORTING NOTE: Multi-Tab only.
function er(t, e) {
    const n = x(t), s = x(n.qe), i = n.kn.get(e);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Fs = this.Fs.insert(this.Ns, new Rr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
...
class {
    ...
    Ni(t, e, n, s) {
        ...
        const r = {};
        return this.ki(r, s), this.Fi(t, i, r, n).then((t => (P("RestConnection", "Received: ", t), 
        t)), (e => {
    ...
    Oi(t, e) {
        ...
        this.useFetchStreams && (l.xmlHttpFactory = new y({})), this.ki(l.initMessageHeaders, e), 
...
function oo(t) {
    return Jr(t) && !_o(t).tr() && t.Fr.length > 0;
}
...
async function ho(t, e, n) {
    const s = t.Fr.shift(), i = Ls.from(s, e, n);
 ...
 */ function _o(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await so(t)) : (await t.Kr.stop(), t.Fr.length > 0 && (P("RemoteStore", `Stopping write stream with ${t.Fr.length} pending writes`), 
        t.Fr = []));
    }))), t.Kr;
}
 ...
 */ class Do {
     ...
     */    Un(t) {
        return t.metadata.exists ? Fn(this.R, t.document, !1) : Rt.newNoDocument(this.qn(t.metadata.name), this.Kn(t.metadata.readTime));
    }
    Kn(t) {
        return bn(t);
    }
 ...
 */ class Mo {
    ...
    s, i, r) {
        ...
        this.ko = new Map, this.Fo = wi.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
 ...
 */ async function Bo(t, e, n, s) {
    ...
    /* usePreviousResults= */ !0), r = new Fo(e, i.Bn), o = r._o(i.documents), c = ln.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.applyChanges(o, 
 ...
 */ function ec(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new ct(j.fromString(e)), s = t.Fo.next();
...
function mu(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), eu("doc", "path", e), t instanceof hu) {
        const s = j.fromString(e, ...n);
...
/** A "context" object passed around while parsing user data. */ class Mu {
    ...
    $c(t) {
        ...
        if (Ou(this.Nc) && ku.test(t)) throw this.Lc('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ function xa(t, e, n, ...s) {
    ...
    return Fa(i, [ o.toMutation(t._key, Ve.exists(!0)) ]);
}
 ...
 */ function ka(t, ...e) {
    ...
    return function(t, e, n, s) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => Ao(await Fc(t), r))), () => {
            i.Wo(), t.asyncQueue.enqueueAndForget((async () => Ro(await Fc(t), r)));
        };
    }(Ru(a), l, c, u);
}
 ...
 */ class Ka {
    ...
    useEmulator(t, e, n = {}) {
        !function(t, e, n, s = {}) {
            var i;
            const r = (t = cu(t, hu))._getSettings();
            if ("firestore.googleapis.com" !== r.host && r.host !== e && S("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
            t._setSettings(Object.assign(Object.assign({}, r), {
                host: `${e}:${n}`,
                ssl: !1
            })), s.mockUserToken) {
                let e, n;
                if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = mr.MOCK_USER; else {
                    // Let createMockUserToken validate first (catches common mistakes like
                    // invalid field "uid" and missing field "sub" / "user_id".)
                    e = a(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
                    const r = s.mockUserToken.sub || s.mockUserToken.user_id;
                    if (!r) throw new R(A.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
                    n = new mr(r);
                }
                t._credentials = new Yc(new Hc(e, n));
            }
 ...
 */ (this._delegate, (e => t(new Wa(this, e))));
    ...
    batch() {
        return Ru(this._delegate), new Ga(new Da(this._delegate, (t => Fa(this._delegate, t))));
    }
    loadBundle(t) {
...
class Ha {
    ...
    set(t, e) {
        ...
        try {
            return function(t, e, n) {
                ...
                return Fa(s, [ qu(Bu(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Ve.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
    ...
    delete() {
        return Fa(cu((t = this._delegate).firestore, Au), [ new qe(t._key, Ve.none()) ]);
        var t;
        /**
...
class ih extends eh {
    ...
    add(t) {
        return function(t, e) {
            ...
            return Fa(n, [ qu(Bu(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Ve.exists(!1)) ]).then((() => s));
