...
import { getUA as f, isSafari as l, isMobileCordova as d, isReactNative as p, isElectron as y, isIE as v, isUWP as m, isBrowserExtension as g, createMockUserToken as w, getModularInstance as b, __PRIVATE_deepEqual as I } from "@firebase/util";

import { Logger as T, LogLevel as E } from "@firebase/logger";

import { XhrIo as S, EventType as _, ErrorCode as N, createWebChannelTransport as D, getStatEventTarget as A, FetchXmlHttpFactory as k, WebChannel as C, Event as x, Stat as R } from "@firebase/webchannel-wrapper";
...
var P = {
    ...
    return t(n, e), n;
}(Error), M = new T("@firebase/firestore");
...
function U(t) {
    ...
    if (M.logLevel <= E.DEBUG) {
        var i = n.map(K);
        M.debug.apply(M, e([ "Firestore (" + L + "): " + t ], i));
    }
}
...
function B(t) {
    ...
    if (M.logLevel <= E.ERROR) {
        var i = n.map(K);
        M.error.apply(M, e([ "Firestore (" + L + "): " + t ], i));
    }
}
...
function j(t) {
    ...
    if (M.logLevel <= E.WARN) {
        var i = n.map(K);
        M.warn.apply(M, e([ "Firestore (" + L + "): " + t ], i));
    }
}
 ...
 */ var J = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new F(P.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new F(P.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new F(P.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new F(P.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var rt = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new F(P.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
...
}(rt), ot = /^[_a-zA-Z][_a-zA-Z0-9]*$/, st = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new F(P.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new F(P.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new F(P.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new F(P.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
}(rt), ut = /** @class */ function() {
    function t(t) {
        this.fields = t, 
 ...
 */ function yt(t) {
    var e = ht(t.mapValue.fields.__local_write_time__.timestampValue);
 ...
 */ var wt = /** @class */ function() {
    ...
    return t.fromPath = function(e) {
        return new t(it.fromString(e));
    }, t.fromName = function(e) {
        return new t(it.fromString(e).popFirst(5));
    }, 
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = ht(t.timestampValue), r = ht(e.timestampValue);
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                var n = ft(t.doubleValue), r = ft(e.doubleValue);
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !It(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function Et(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            var n = ft(t.integerValue || t.doubleValue), r = ft(e.integerValue || e.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Y(ft(t.latitude), ft(e.latitude));
            return 0 !== n ? n : Y(ft(t.longitude), ft(e.longitude));
...
function St(t, e) {
    ...
    var n = ht(t), r = ht(e), i = Y(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function Lt(t) {
    ...
    if (t.mapValue) {
        ...
        return et(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = Lt(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Lt(t.arrayValue.values[r]);
        return n;
    }
 ...
 */ var Ot = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Rt(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Lt(t) : i.push(o.lastSegment());
        }));
    ...
    t.prototype.delete = function(t) {
        ...
        Rt(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }, t.prototype.isEqual = function(t) {
        return It(this.value, t.value);
    }, 
    /**
 ...
 */ function Pt(t) {
    var e = [];
    return et(t.fields, (function(t, n) {
        var r = new st([ t ]);
        if (Rt(n)) {
            var i = Pt(n.mapValue).fields;
            if (0 === i.length) 
...
var Ft = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , Z.min(), Ot.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, Ot.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, Ot.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function Ut(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!te(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], 
    i.op !== o.op || !i.field.isEqual(o.field) || !It(i.value, o.value)) return !1;
    var i, o;
...
var jt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new Kt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Wt(t, r) : "in" /* IN */ === e ? new Ht(t, r) : "not-in" /* NOT_IN */ === e ? new Yt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Xt(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
        return "in" /* IN */ === e ? new Gt(t, n) : new zt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(Et(e, this.value)) : null !== e && bt(this.value) === bt(e) && this.m(Et(e, this.value));
...
var Kt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = wt.fromName(r.referenceValue), 
        i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = wt.comparator(t.key, this.key);
        return this.m(e);
    }, n;
}(jt), Gt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
/** Filter that matches on key fields within an array. */ function Qt(t, e) {
    ...
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return wt.fromName(t.referenceValue);
    }));
}

/** A Filter that implements the array-contains operator. */ var Wt = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return kt(e) && Tt(e.arrayValue, this.value);
    }, n;
}(jt), Ht = /** @class */ function(e) {
    function n(t, n) {
 ...
 */ function ee(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? wt.comparator(wt.fromName(s.referenceValue), n.key) : Et(s, n.data.field(o.field)), 
...
function ne(t, e) {
    ...
    for (var n = 0; n < t.position.length; n++) if (!It(t.position[n], e.position[n])) return !1;
    return !0;
}
...
/** Creates a new Query instance with the options provided. */ function ie(t, e, n, r, i, o, s, u) {
 ...
 */ function fe(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Zt(n)), e.p.push(new Zt(st.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function le(t) {
    var e = Q(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Vt(e.path, e.collectionGroup, fe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = fe(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Zt(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new $t(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new $t(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.T = Vt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.T;
}
...
function pe(t, e) {
    return Ut(le(t), le(e)) && t.limitType === e.limitType;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function me(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !ee(t.startAt, fe(t), e)) && (!t.endAt || !ee(t.endAt, fe(t), e));
    }(t, e);
}

function ge(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = fe(t); i < o.length; i++) {
            var s = o[i], u = we(s, e, n);
            if (0 !== u) return u;
...
function we(t, e, n) {
    var r = t.field.isKeyField() ? wt.comparator(e.key, n.key) : function(t, e, n) {
        var r = e.data.field(t), i = n.data.field(t);
        return null !== r && null !== i ? Et(r, i) : G();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ function Se(t, e, n) {
    ...
    }(n, e) : t instanceof Ae ? ke(t, e) : t instanceof Ce ? xe(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Ne(t, e), r = Le(n) + Le(t.A);
        return At(n) && At(t.A) ? Ie(r) : be(t.R, r);
    }(t, e);
}
 ...
 */ function _e(t, e, n) {
    ...
    // applications.
    return t instanceof Ae ? ke(t, e) : t instanceof Ce ? xe(t, e) : n;
}
 ...
 */ function Ne(t, e) {
    return t instanceof Re ? At(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var De = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
}(Ee), Ae = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
/** Transforms an array value via a remove operation. */ var Ce = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Pe = function(t, e) {
 ...
 */ function Ue(t, e, n) {
    t instanceof ze ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = He(t.fieldTransforms, e, n.transformResults);
        ...
        if (Ve(t.precondition, e)) {
            var r = He(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(We(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Be(t, e, n) {
    t instanceof ze ? function(t, e, n) {
        if (Ve(t.precondition, e)) {
            var r = t.value.clone(), i = Ye(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Ge(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof Qe ? function(t, e, n) {
        if (Ve(t.precondition, e)) {
            var r = Ye(t.fieldTransforms, n, e), i = e.data;
            i.setAll(We(t)), i.setAll(r), e.convertToFoundDocument(Ge(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Ve(t.precondition, e) && 
 ...
 */ function je(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Ne(o.transform, s || null);
        null != u && (null == n && (n = Ot.empty()), n.set(o.field, u));
    }
    return n || null;
}
...
function Ke(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.precondition.isEqual(e.precondition) && !!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && X(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ae && e instanceof Ae || t instanceof Ce && e instanceof Ce ? X(t.elements, e.elements, It) : t instanceof Re && e instanceof Re ? It(t.A, e.A) : t instanceof De && e instanceof De;
...
/** A mutation that deletes the document at the given key. */ var Xe, $e, Je = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ ($e = Xe || (Xe = {}))[$e.OK = 0] = "OK", $e[$e.CANCELLED = 1] = "CANCELLED", 
$e[$e.UNKNOWN = 2] = "UNKNOWN", $e[$e.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
$e[$e.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", $e[$e.NOT_FOUND = 5] = "NOT_FOUND", 
$e[$e.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", $e[$e.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
$e[$e.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", $e[$e.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
$e[$e.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", $e[$e.ABORTED = 10] = "ABORTED", 
$e[$e.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", $e[$e.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
...
var rn = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, sn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, sn.BLACK, null, null));
    }, 
...
}(), cn = new rn(wt.comparator);

function hn() {
    return cn;
}

var fn = new rn(wt.comparator);
 ...
 */ var wn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, bn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(Z.min(), r, gn(), hn(), vn());
    }, t;
}(), bn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(at.EMPTY_BYTE_STRING, n, vn(), vn(), vn());
    }, t;
}(), In = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = at.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Bt(i)) if (0 === n) {
                ...
                // queries.
                var o = new wt(i.path);
                this.tt(e, o, Ft.newNoDocument(o, Z.min()));
            } else z(1 === n); else this.ct(e) !== n && (
    ...
    t.prototype.at = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Bt(o.target)) {
                    ...
                    var s = new wt(o.target.path);
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, Ft.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        var i = new wn(t, n, this.Y, this.H, r);
        return this.H = hn(), this.J = Nn(), this.Y = new un(Y), i;
    }, 
    /**
    ...
    t.prototype.q = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new un(Y), this.J = this.J.insert(t, e)), e;
    }, 
    /**
...
function On(t) {
    return z(!!t), Z.fromTimestamp(function(t) {
        var e = ht(t);
        return new J(e.seconds, e.nanos);
    }(t));
}
...
function Fn(t) {
    var e = it.fromString(t);
    return z(sr(e)), e;
}

function Mn(t, e) {
    return Pn(t.databaseId, e.path);
}

function Vn(t, e) {
    var n = Fn(e);
    if (n.get(1) !== t.databaseId.projectId) throw new F(P.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new F(P.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new wt(jn(n));
}

function qn(t, e) {
    return Pn(t.databaseId, e);
}
...
function Un(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? it.emptyPath() : jn(e);
}
...
function Gn(t, e, n) {
    var r = Vn(t, e.name), i = On(e.updateTime), o = new Ot({
        mapValue: {
            fields: e.fields
        }
    }), s = Ft.newFoundDocument(r, i, o);
...
function Qn(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Me.updateTime(On(t.updateTime)) : void 0 !== t.exists ? Me.exists(t.exists) : Me.none();
    }(e.currentDocument) : Me.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new De; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Ae(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Ce(i);
            } else "increment" in e ? n = new Re(t, e.increment) : G();
            var o = st.fromServerFormat(e.fieldPath);
            return new Pe(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Vn(t, e.update.name), o = new Ot({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                ...
                return new ut(e.map((function(t) {
                    return st.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new Qe(i, o, s, n, r);
        }
        return new ze(i, o, n, r);
    }
    if (e.delete) {
        var u = Vn(t, e.delete);
        return new Je(u, n);
...
function Hn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = qn(t, r), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = qn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = $n(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = $n(e.endAt)), n;
}

function Yn(t) {
    var e = Un(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = Xn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new Zt(nr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var h = null;
    return n.endAt && (h = Jn(n.endAt)), ie(e, i, u, s, a, "F" /* First */ , c, h);
}

function Xn(t) {
    return t ? void 0 !== t.unaryFilter ? [ ir(t) ] : void 0 !== t.fieldFilter ? [ rr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Xn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : G() : [];
...
function rr(t) {
    return jt.create(nr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function ir(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = nr(t.unaryFilter.field);
        return jt.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = nr(t.unaryFilter.field);
        return jt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = nr(t.unaryFilter.field);
        return jt.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = nr(t.unaryFilter.field);
 ...
 */ function ur(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = cr(e)), e = ar(t.get(n), e);
    return cr(e);
}
...
/** Encodes a path separator into the given result */ function cr(t) {
    return t + "";
}
 ...
 */ function hr(t) {
    ...
    var e = t.length;
    if (z(e >= 2), 2 === e) return z("" === t.charAt(0) && "" === t.charAt(1)), it.emptyPath();
...
/** Name of the IndexedDb object store.  */ Ir.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Ir.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Ir.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Ir.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ Er.store = "collectionParents", 
...
/** Name of the IndexedDb object store. */ Sr.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ _r.store = "bundles", _r.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Nr.store = "namedQueries", Nr.keyPath = "name";

// Visible for testing
var Dr = e(e([], e(e([], e(e([], e(e([], [ dr.store, pr.store, yr.store, gr.store, br.store, lr.store, Tr.store, Ir.store ]), [ Sr.store ])), [ wr.store ])), [ Er.store ])), [ _r.store, Nr.store ]), Ar = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", kr = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.ft = new Cr, this.transaction.oncomplete = function() {
            n.ft.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.ft.reject(new Pr(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Ur(e.target.error);
            n.ft.reject(new Pr(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), Vr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new Pr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new F(P.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Pr(t, n));
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = r.sent(), e = Rr.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), xr.reject(t);
 ...
 */ var Mr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), Vr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return U("SimpleDb", "DELETE", this.store.name, t), Vr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), Vr(this.store.count());
    ...
    t.prototype.Ft = function(t) {
        ...
        var n = [];
        return new xr((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new Or(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof xr) {
                        var u = s.catch((function(t) {
                            return o.done(), xr.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 */ var Kr = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Ue(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Be(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && Be(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        e.applyToLocalView(i), r.isValidDocument() || i.convertToNoDocument(Z.min());
        }));
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = pn(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = Z.min()), void 0 === o && (o = Z.min()), void 0 === s && (s = at.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function Wr(t, e) {
    if (e.document) return Gn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = wt.fromSegments(e.noDocument.path), r = Jr(e.noDocument.readTime), i = Ft.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = wt.fromSegments(e.unknownDocument.path), s = Jr(e.unknownDocument.version);
        return Ft.newUnknownDocument(o, s);
    }
    return G();
}

/** Encodes a document for storage locally. */ function Hr(t, e, n) {
    var r = Yr(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = $r(e.version), c = e.hasCommittedMutations;
        return new gr(
        /* unknownDocument= */ null, new vr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = $r(e.version);
        return new gr(new mr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Zr(t, e) {
...
/** Decodes a DbTarget into TargetData */ function ti(t) {
    var e, n, r = Jr(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Jr(t.lastLimboFreeSnapshotVersion) : Z.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = le(oe(Un(n.documents[0])))) : e = function(t) {
        return le(Yn(t));
    }(t.query), new zr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, at.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function ei(t, e) {
    var n, r = $r(e.snapshotVersion), i = $r(e.lastLimboFreeSnapshotVersion);
    n = Bt(e.target) ? Wn(t.Lt, e.target) : Hn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new br(e.targetId, qt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ function ii(t) {
    return jr(t, _r.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function oi(t) {
    return jr(t, Nr.store);
}
 ...
 */ var si = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), xr.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return xr.resolve(this.Bt.getEntries(e));
    }, t;
}(), ui = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new un(it.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new un(it.comparator)).toArray();
    }, t;
}(), ai = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return ci(t).Nt(r).next((function(t) {
 ...
 */
function li(t, e, n) {
    var r = t.store(pr.store), i = t.store(yr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ot({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = yr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return xr.waitFor(o).next((function() {
        return c;
    }));
}
...
var pi = /** @class */ function() {
    ...
    return t.jt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            ...
            }(i.R, i.userId, a), h = [], f = new un((function(t, e) {
                return Y(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = yr.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, yr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.qt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Kt[u] = a.keys();
            })), xr.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return vi(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), Zr(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Qt = function(t, e) {
        var n = this;
        return this.Kt[e] ? xr.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Kt[e] = r, r;
            }
        ...
        return vi(t).Ot({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = Zr(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return vi(t).Nt(pr.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return Zr(e.R, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = yr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return mi(t).Ot({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], c = r[2], h = hr(a);
            ...
            return vi(t).get(c).next((function(t) {
                if (!t) throw G();
                z(t.userId === n.userId), o.push(Zr(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new un(Y), i = [];
        return e.forEach((function(e) {
            var o = yr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = mi(t).Ot({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = hr(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), xr.waitFor(i).next((function() {
            return n.Wt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = yr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new un(Y);
        return mi(t).Ot({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = hr(a);
        ...
        return e.forEach((function(e) {
            i.push(vi(t).get(e).next((function(t) {
                if (null === t) throw G();
                z(t.userId === n.userId), r.push(Zr(n.R, t));
            })));
        })), xr.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return li(t.Mt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.Gt(e.batchId);
            })), xr.forEach(r, (function(e) {
    ...
    t.prototype.Gt = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            if (!n) return xr.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(yr.prefixForUser(e.userId)), i = [];
            return mi(t).Ot({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
    ...
    t.prototype.zt = function(t) {
        var e = this;
        return gi(t).get(this.userId).next((function(t) {
 ...
 */ function yi(t, e, n) {
    var r = yr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return mi(t).Ot({
        range: o,
        $t: !0
    }, (function(t, n, r) {
 ...
 */ var wi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Xt(t).next((function(t) {
            return Z.fromTimestamp(new J(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Ii(t).Ot((function(t, n) {
            var r = ti(n);
            e(r);
        }));
    }, t.prototype.Xt = function(t) {
        return Ti(t).get(Tr.key).next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.Zt = function(t, e) {
        return Ti(t).put(Tr.key, e);
    }, t.prototype.te = function(t, e) {
        return Ii(t).put(ei(this.R, e));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        var n = qt(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Ii(t).Ot({
            range: r,
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = ur(e.path);
            i.push(o.put(new Ir(n, s))), i.push(r.referenceDelegate.addReference(t, n, e));
        })), xr.waitFor(i);
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        var r = this, i = Ei(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return xr.forEach(e, (function(e) {
            var o = ur(e.path);
            return xr.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = Ei(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ei(t), i = vn();
        return r.Ot({
            range: n,
            $t: !0
        }, (function(t, e, n) {
            var r = hr(t[1]), o = new wt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = ur(e.path), r = IDBKeyRange.bound([ n ], [ $(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ei(t).Ot({
 ...
 */ function Si(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== P.FAILED_PRECONDITION || t.message !== Ar) throw t;
 ...
 */ var Ni = /** @class */ function() {
    function t(t) {
        this.ne = t, this.buffer = new un(_i), this.se = 0;
    }
    return t.prototype.ie = function() {
        ...
        if (this.buffer.size < this.ne) this.buffer = this.buffer.add(e); else {
            ...
            _i(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
    ...
    return t.prototype.start = function(t) {
        ...
        U("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Fr(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        xr.resolve(hi)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), V() <= E.DEBUG && U("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            xr.resolve({
                didRun: !0,
    ...
    t.prototype._e = function(t, e) {
        return function(t, e) {
            var n = !1;
            return gi(t).Ft((function(r) {
                return yi(t, r, e).next((function(t) {
                    return t && (n = !0), xr.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n._e(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), Ei(t).delete([ 0, ur(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var xi = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return nt(this.inner);
    }, t;
}(), Ri = /** @class */ function() {
    function t() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.changes = new xi((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.removeEntry = function(t, e) {
        void 0 === e && (e = null), this.assertNotApplied(), this.changes.set(t, {
            document: Ft.newInvalidDocument(t),
            readTime: e
        });
    }, 
    /**
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? xr.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Fi(t).get(Mi(e)).next((function(t) {
            return n.ge(e, t);
        }));
    }, 
    /**
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = hn(), i = new rn(wt.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ge(t, e);
            r = r.insert(t, o), i = i.insert(t, di(e));
        })).next((function() {
            return {
                documents: r,
                Te: i
        ...
        return Fi(t).Ot({
            ...
            for (var s = wt.fromSegments(t); o && wt.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
        ...
        var r = this, i = hn(), o = e.path.length + 1, s = {};
        if (n.isEqual(Z.min())) {
        ...
        return Fi(t).Ot(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = Wr(r.R, n);
                e.path.isPrefixOf(u.key.path) ? me(e, u) && (i = i.insert(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
        ...
        return Pi(t).get(wr.key).next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Pi(t).put(wr.key, e);
    }, 
    /**
    ...
    t.prototype.ge = function(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!n.isNoDocument() || !n.version.isEqual(Z.min())) return n;
        }
        return Ft.newInvalidDocument(t);
    }, t;
}(), Oi = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                var a = Hr(e.Ie.R, s.document, e.getReadTime(o));
 ...
 */ function Pi(t) {
    return jr(t, wr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Fi(t) {
    return jr(t, gr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Vi = /** @class */ function() {
    function t(t) {
        this.R = t;
    }
    /**
     ...
     */    return t.prototype.Rt = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Ir.store), t.deleteObjectStore(br.store), t.deleteObjectStore(Tr.store);
        }(t), qi(t)), s = s.next((function() {
            /**
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(pr.store).Nt().next((function(n) {
        ...
        var e = 0;
        return t.store(gr.store).Ot((function(t, n) {
            e += di(n);
        })).next((function() {
            var n = new wr(e);
        ...
        var e = this, n = t.store(dr.store), r = t.store(pr.store);
        return n.Nt().next((function(n) {
            return xr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Nt(pr.userMutationsIndex, i).next((function(r) {
                    return xr.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = Zr(e.R, r);
    ...
    t.prototype.be = function(t) {
        var e = t.store(Ir.store), n = t.store(gr.store);
        return t.store(Tr.store).get(Tr.key).next((function(t) {
            var r = [];
            return n.Ot((function(n, i) {
                var o = new it(n), s = function(t) {
                    return [ 0, ur(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? xr.resolve() : function(n) {
                        return e.put(new Ir(0, ur(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return xr.waitFor(r);
        ...
        var n = e.store(Er.store), r = new ui, i = function(t) {
            if (r.add(t)) {
...
var Ui = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Bi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        }, !t.gt()) throw new F(P.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new ki(this, i), this.Le = n + "main", this.R = new Qr(a), 
        this.Be = new Lr(this.Le, 11, new Vi(this.R)), this.Ue = new bi(this.referenceDelegate, this.R), 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new F(P.FAILED_PRECONDITION, Ui);
    ...
    t.prototype.Qe = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Ki(e).put(new Sr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return ji(t).get(lr.key).next((function(t) {
            return xr.resolve(e.tn(t));
        }));
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.Nt().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return xr.forEach(r, (function(t) {
    ...
    t.prototype.Ye = function(t) {
        var e = this;
        return this.Ce ? xr.resolve(!0) : ji(t).get(lr.key).next((function(n) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.hn(), [ 4 /*yield*/ , this.Be.runTransaction("shutdown", "readwrite", [ lr.store, Sr.store ], (function(e) {
                        var n = new Br(e, O.o);
    ...
    t.prototype.fn = function() {
        ...
        return this.Be.runTransaction(t, o, Dr, (function(o) {
            return i = new Br(o, r.Ne ? r.Ne.next() : O.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new F(P.FAILED_PRECONDITION, Ar);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return ji(t).get(lr.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new F(P.FAILED_PRECONDITION, Ui);
        }));
    }, 
    /**
    ...
    t.prototype.Ze = function(t) {
        var e = new lr(this.clientId, this.allowTabSynchronization, Date.now());
        return ji(t).put(lr.key, e);
    }, t.gt = function() {
        return Lr.gt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        var e = this, n = ji(t);
        return n.get(lr.key).next((function(t) {
            return e.tn(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete(lr.key)) : xr.resolve();
        }));
    }, 
    ...
    t.prototype.Ge = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ke = function() {
            ...
            e.an(), l() && navigator.appVersion.match("Version/14") && 
 ...
 */
        ...
        return this.mn(t, new wt(e)).next((function(t) {
            var e = ln();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.In = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = ln();
        return this.qt.getCollectionParents(t, i).next((function(s) {
            return xr.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new re(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Ft.newInvalidDocument(c), r = r.insert(c, h)), Be(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = vn(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(Z.min()) ? this.Dn(t, e) : this.Sn.pn(t, r).next((function(o) {
            var s = i.Cn(e, o);
            return (se(e) || ue(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (V() <= E.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ve(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return V() <= E.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", ve(e)), 
 ...
 */ function Ji(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = xr.resolve();
 ...
 */ function to(t, e) {
     ...
     */
        ...
        s.push(eo(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(Z.min())) {
        ...
        return xr.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, u);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual(Z.min()) ? (
 ...
 */ function ro(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ue.getTargetData(t, e).next((function(i) {
            ...
            r = i, xr.resolve(r)) : n.Ue.allocateTargetId(t).next((function(i) {
                return r = new zr(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Ue.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
 ...
 */ function oo(t, e, n) {
    var r = Q(t), i = Z.min(), o = vn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = r.$n.get(n);
            return void 0 !== i ? xr.resolve(r.kn.get(i)) : r.Ue.getTargetData(e, n);
        }(r, t, le(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ue.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : Z.min(), n ? o : vn());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
...
function uo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = hn(), o = Yr(n), s = Fi(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
 ...
 */ function co(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = Q(t), s = vn(), u = hn(), a = pn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                ...
                return d = n.Fn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , ro(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return le(oe(it.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return eo(t, d, u, Z.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function ho(t, e, i) {
    return void 0 === i && (i = vn()), n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ro(t, le(ni(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = Q(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(at.EMPTY_BYTE_STRING, r);
 ...
 */ var fo = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return xr.resolve(this.jn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return xr.resolve(this.Qn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Wn = new un(po.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new un(po.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new wt(new it([])), r = new po(n, t), i = new po(n, t + 1), o = [];
        ...
        var e = new wt(new it([])), n = new po(e, t), r = new po(e, t + 1), i = vn();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new po(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    return t.Gn = function(t, e) {
        return wt.comparator(t.key, e.key) || Y(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return Y(t.ns, e.ns) || wt.comparator(t.key, e.key);
    }, t;
}(), yo = /** @class */ function() {
    function t(t, e) {
        ...
        this.rs = new un(po.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return xr.resolve(0 === this._n.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ss;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.rs = this.rs.add(new po(a.key, i)), this.qt.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return xr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return xr.resolve(this.os(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.cs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return xr.resolve(this._n.length > i ? this._n[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return xr.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return xr.resolve(this._n.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        ...
        var o = new po(new wt(i), 0), s = new un(Y);
        ...
        var r = this.rs;
        return xr.forEach(e.mutations, (function(i) {
        ...
        var n = new po(e, 0), r = this.rs.firstAfterOrEqual(n);
        return xr.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, xr.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new rn(wt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return xr.resolve(n ? n.document.clone() : Ft.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = hn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Ft.newInvalidDocument(t));
        })), xr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = hn(), i = new wt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || me(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return xr.resolve(r);
    }, t.prototype.fs = function(t, e) {
        return xr.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(Ri), go = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new xi((function(t) {
            return qt(t);
        }), Ut), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new lo, this.targetCount = 0, this.gs = wi.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return xr.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.gs.next(), xr.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        return this.te(e), this.targetCount += 1, xr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), xr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this._s.Jn(e, n), xr.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this._s.Xn(e, n);
        ...
        return this._s.Zn(e), xr.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return xr.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return xr.resolve(this._s.containsKey(e));
    }, t;
}(), wo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.ys = {}, this.Ne = new O(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
        this.Ue = new go(this), this.qt = new si, this.qe = function(t, e) {
            return new vo(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.qt), this.R = new Qr(e), this.Ke = new fo(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new yo(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.Ue;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return xr.or(Object.values(this.ys).map((function(n) {
            return function() {
    ...
    return t.Ps = function(e) {
        ...
        return this.As.addReference(n, e), this.bs.delete(n.toString()), xr.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), xr.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.bs.add(e.toString()), xr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return xr.forEach(this.bs, (function(r) {
            var i = wt.fromPath(r);
        ...
        var n = this;
        return xr.or([ function() {
            return xr.resolve(n.As.containsKey(e));
        }, function() {
...
/** Assembles the key for a query state in WebStorage */ function _o(t, e) {
 ...
 */
// Visible for testing
/** A user with a null UID. */ To.UNAUTHENTICATED = new To(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
To.GOOGLE_CREDENTIALS = new To("google-credentials-uid"), To.FIRST_PARTY = new To("first-party-uid"), 
To.MOCK_USER = new To("mock-user");
...
var No = /** @class */ function() {
    ...
    return t.Vs = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new F(o.error.code, o.error.message))), 
    ...
    return t.Vs = function(e, n) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new F(i.error.code, i.error.message))), 
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = gn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = gt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.$s = new rn(Y), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = Eo(this.persistenceKey, this.Ns), 
        this.Ms = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$s = this.$s.insert(this.Ns, new Co), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.gt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(Eo(this.persistenceKey, i))) && (s = Ao.Vs(i, o)) && (this.$s = this.$s.insert(s.clientId, s));
        ...
        // by another tab
            ...
            var n = this.storage.getItem(_o(this.persistenceKey, t));
            if (n) {
                var r = Do.Vs(t, n);
                r && (e = r.state);
            }
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ls.test(i.key)) {
                                ...
                                return e;
                            }(i.newValue)) !== O.o && this.sequenceNumberHandler(u); else if (i.key === this.Ks) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new No(this.currentUser, t, e, n), i = So(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Ss());
        ...
        var r = _o(this.persistenceKey, t), i = new Do(t, e, n);
        this.setItem(r, i.Ss());
    ...
    t.prototype.Qs = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ai(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    function t() {
        this.li = new Co, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.li = new Co, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.$i = function(t, e, n, r) {
            ...
            s.listenOnce(_.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case N.TIMEOUT:
                        U("Connection", 'RPC "' + t + '" timed out'), o(new F(P.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case N.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new F(u, r.message));
                            } else o(new F(P.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new F(P.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var u = r.createWebChannel(s, o), a = !1, c = !1, h = new Fo({
            Ei: function(t) {
                c ? U("Connection", "Not sending because WebChannel is closed:", t) : (a || (U("Connection", "Opening WebChannel transport."), 
                u.open(), a = !0), U("Connection", "WebChannel sending:", t), u.send(t));
            },
            Ti: function() {
                return u.close();
            }
        ...
        return f(u, C.EventType.OPEN, (function() {
            ...
            c || (c = !0, j("Connection", "WebChannel transport errored:", t), h.Vi(new F(P.UNAVAILABLE, "The operation could not be completed")));
 ...
 */ var Bo = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Bo(t, e)
        /**
    ...
    t.prototype.ur = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new F(P.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (z(void 0 === e || "string" == typeof e), at.fromBase64String(e || "")) : (z(void 0 === e || e instanceof Uint8Array), 
                    at.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? P.UNKNOWN : nn(t.code);
                ...
                var c = Vn(t, a.document.name), h = On(a.document.updateTime), f = new Ot({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Ft.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new In(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Vn(t, y.document), m = y.readTime ? On(y.readTime) : Z.min(), g = Ft.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new In([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Vn(t, b.document), T = b.removedTargetIds || [];
                n = new In([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new tn(S), N = E.targetId;
                n = new Tn(N, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? Z.min() : e.readTime ? On(e.readTime) : Z.min();
        }(t);
    ...
    n.prototype.mr = function(t) {
        ...
        e.database = Bn(this.R), e.addTarget = function(t, e) {
            ...
            return (n = Bt(r) ? {
                ...
                query: Hn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Rn(t, e.resumeToken) : e.snapshotVersion.compareTo(Z.min()) > 0 && (
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = On(e)), new Fe(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = On(t.commitTime);
    ...
    return t(n, e), n.prototype.Pr = function() {
        if (this.Rr) throw new F(P.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
        ...
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ns(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Fr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Yo(e) ];
 ...
 */ function $o(t, e) {
    var n = Q(t), r = ms(n);
    n.Or.delete(e), r.er() && Zo(n, e), 0 === n.Or.size && (r.er() ? r.ir() : ns(n) && 
...
function es(t) {
    return ns(t) && !ms(t).tr() && t.Or.size > 0;
}
...
function ss(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof En && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof In ? t.Ur.X(e) : e instanceof Tn ? t.Ur.rt(e) : t.Ur.et(e), i.isEqual(Z.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Zi(t.localStore) ];
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , us(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Fr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Yo(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Fr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ho(t) ];
...
function cs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = Q(t), n = gs(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , no(e.localStore, i) ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , us(e, s) ];
...
function hs(t) {
    return ns(t) && !gs(t).tr() && t.$r.length > 0;
}
...
function ds(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = gs(t), n = 0, i = t.$r; n < i.length; n++) o = i[n], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function ps(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.$r.shift(), o = Gr.from(n, e, i), [ 4 /*yield*/ , as(t, (function() {
...
function ys(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && gs(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return en(i = e.code) && i !== P.ABORTED ? (n = t.$r.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                gs(t).sr(), [ 4 /*yield*/ , as(t, (function() {
 ...
 */ function vs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), e ? (n.Fr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Ho(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Fr.add(2 /* IsSecondary */), [ 4 /*yield*/ , Yo(n) ]);
    ...
    t.qr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.qr.sr(), es(t) ? ts(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function gs(t) {
    ...
    t.Kr = function(t, e, n) {
        var r = Q(t);
        return r.Pr(), new Go(e, r.Hi, r.credentials, r.R, n);
    }(t.datastore, t.asyncQueue, {
        Ii: ls.bind(null, t),
        Ri: ys.bind(null, t),
        Ir: ds.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Kr.sr(), [ 4 /*yield*/ , cs(t) ]) : [ 3 /*break*/ , 2 ];
...
var ws = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Cr, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new F(P.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function bs(t, e) {
    if (B("AsyncQueue", e + ": " + t), Fr(t)) return new F(P.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Is = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.comparator = t ? function(e, n) {
            return t(e, n) || wt.comparator(e.key, n.key);
        } : function(t, e) {
            return wt.comparator(t.key, e.key);
        }, this.keyedMap = ln(), this.sortedSet = new rn(this.comparator)
        /**
    ...
    this.queries = new xi((function(t) {
        return ye(t);
    }), pe), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Ns(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = Q(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Ss), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 3:
                return a = r.sent(), c = bs(a, "Initialization of query '" + ve(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && Cs(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var xs = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = Es.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), Rs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.qn = function(t) {
        return t.metadata.exists ? Gn(this.R, t.document, !1) : Ft.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Ps(t)
        /**
    ...
    return t.prototype.oo = function(t) {
        ...
        for (var e = new Map, n = new Ls(this.R), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , co(this.localStore, new Ls(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = r.sent(), e = this.co(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , ho(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Fs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = vn(), this.lo = ge(t), this.fo = new Is(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new Ts, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = se(this.query) && i.size === this.query.limit ? i.last() : null, c = ue(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = me(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), se(this.query) || ue(this.query)) for (;s.size > this.query.limit; ) {
            var h = se(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.uo = u, 0 !== o.length || a ? {
            snapshot: new Es(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = vn(), this.fo.forEach((function(e) {
            t.Io(e.key) && (t.ho = t.ho.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ho.has(e) || n.push(new Ms(e));
    ...
    t.prototype.Ro = function() {
        return Es.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), qs = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.bo = {}, this.vo = new xi((function(t) {
            return ye(t);
        }), pe), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new rn(wt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new lo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ko = new Map, this.$o = wi.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , ro(n.localStore, le(e)) ];

              case 2:
                return u = r.sent(), a = n.sharedClientState.addLocalQueryTarget(u.targetId), i = u.targetId, 
                [ 4 /*yield*/ , Ks(n, e, i, "current" === a) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && Xo(n.remoteStore, u), r.label = 4;
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view._o(i), n.Nn ? [ 4 /*yield*/ , oo(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (nu(t, e.targetId, u.To), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , oo(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), u = new Vs(e, s.Bn), a = u._o(s.documents), c = bn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), nu(t, i, h.To), f = new qs(e, i, u), 
...
/** Stops listening to the query. */ function Gs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , io(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), $o(n.remoteStore, i.targetId), 
                    tu(n, i.targetId);
                })).catch(Si) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return tu(n, i.targetId), [ 4 /*yield*/ , io(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = Q(t), i = J.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), vn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Qe(c.key, h, Pt(h.value.mapValue), Me.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new rn(Y)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , ou(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , cs(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = bs(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                (s = o && o.key) ? (u = (u = new rn(wt.comparator)).insert(s, Ft.newNoDocument(s, Z.min())), 
                a = vn().add(s), c = new wn(Z.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new un(Y), u, a), [ 4 /*yield*/ , Qs(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Do = n.Do.remove(s), n.Co.delete(e), iu(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , io(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return tu(n, e, i);
                })).catch(Si) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                Zs(n, i, /*error=*/ null), Js(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , ou(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                Zs(n, e, i), Js(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , ou(n, o) ];
 ...
 */ function $s(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ns((n = Q(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 3:
                return s = r.sent(), u = bs(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function eu(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && ($o(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), iu(t));
}

function nu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Fs ? (t.No.addReference(o.key, e), ru(t, o)) : o instanceof Ms ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function iu(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new wt(it.fromString(e)), r = t.$o.next();
        t.Co.set(r, new Us(n)), t.Do = t.Do.insert(n, r), Xo(t.remoteStore, new zr(le(oe(n.path)), r, 2 /* LimboResolution */ , O.o));
    }
}
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return xr.forEach(e, (function(e) {
                                        return xr.forEach(e.Pn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return xr.forEach(e.bn, (function(r) {
...
function su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = Q(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (U("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , $i(n.localStore, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.ko.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new F(P.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.ko.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , ou(n, i.Ln) ];
...
function uu(t, e) {
    ...
    if (r && r.Po) return vn().add(r.key);
    var i = vn(), o = n.Vo.get(e);
    if (!o) return i;
 ...
 */ function au(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , oo((n = Q(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Ao(i), [ 2 /*return*/ , (n.isPrimaryClient && nu(n, e.targetId, o.To), 
                o) ];
            }
        }));
    }));
...
function cu(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , uo((e = Q(t)).localStore).then((function(t) {
                return ou(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Qt(t, e).next((function(e) {
                            return e ? n.Mn.pn(t, e) : xr.resolve(null);
                        }));
                    }));
                }((n = Q(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , cs(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                Zs(n, e, o || null), Js(n, e), function(t, e) {
                    Q(Q(t)._n).Gt(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , ou(n, s) ];
...
function fu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return mu(n = Q(t)), gu(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , lu(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Oo = !0, [ 4 /*yield*/ , vs(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Xo(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Vo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return tu(n, e), io(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), $o(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , lu(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        $o(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new rn(wt.comparator);
                }(n), n.Oo = !1, [ 4 /*yield*/ , vs(n.remoteStore, !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Vo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , ro(n.localStore, le(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.vo.get(d), [ 4 /*yield*/ , au(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , so(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , ro(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Ks(n, du(v), a, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                return [ 4 /*yield*/ , uo(n.localStore) ];

              case 3:
                return s = r.sent(), u = wn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , ou(n, s, u) ];
              ...
              case 6:
                return r.sent(), tu(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function vu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = mu(t)).Oo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Vo.has(u) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , so(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , ro(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Ks(n, du(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Xo(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Vo.has(t) ? [ 4 /*yield*/ , io(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                $o(n.remoteStore, t), tu(n, t);
                            })).catch(Si) ] : [ 3 /*break*/ , 2 ];
...
function mu(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Qs.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = uu.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Hs.bind(null, e), e.bo._r = As.bind(null, e.eventManager), 
    e.bo.Mo = ks.bind(null, e.eventManager), e;
}

function gu(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Ys.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Xs.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Ps(n)), o = new Os(n, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , ou(t, a.wn, 
                    /* remoteEvent */ void 0) ];
...
var bu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Uo(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        return Xi(this.persistence, new Hi, t.initialUser, this.R);
    }, t.prototype.Uo = function(t) {
        return new wo(Io.Ps, this.R);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , ao(this.localStore) ];
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , gu(this.jo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , cs(this.jo.remoteStore) ];
        ...
        var e = Gi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? fi.withCacheSize(this.cacheSizeBytes) : fi.DEFAULT;
        return new Bi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Vo(), qo(), this.R, this.sharedClientState, !!this.forceOwnership);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.jo.syncEngine, this.sharedClientState instanceof xo ? (this.sharedClientState.syncEngine = {
                        ai: hu.bind(null, i),
                        ui: yu.bind(null, i),
                        hi: vu.bind(null, i),
                        fn: pu.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.He((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , fu(this.jo.syncEngine, t) ];
        ...
        var e = Vo();
        if (!xo.gt(e)) throw new F(P.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Gi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new xo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Iu), Eu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Ws(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = su.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , vs(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Uo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Mo(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Ws(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Oo.gt() ? new Oo : new Lo, new Wo(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new Bs(t, e, n, r, i, o);
            return s && (u.Oo = !0), u;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = Q(t), U("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Yo(e) ];
 ...
 */ var _u = /** @class */ function() {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Rs(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new F(P.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, u, a;
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = Q(t), i = Bn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Vn(t, e.found.name), r = On(e.found.updateTime), i = new Ot({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Ft.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                z(!!e.missing), z(!!e.readTime);
                                                var n = Vn(t, e.missing), r = On(e.readTime);
                                                return Ft.newNoDocument(n, r);
                                            }(t, e) : G();
                                        }(n.R, t);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = wt.fromPath(n);
                        e.mutations.push(new Ze(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new F(P.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new F(P.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.ec = 5, this.Zi = new Bo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = To.UNAUTHENTICATED, 
        this.clientId = H.u(), this.credentialListener = function() {
            return Promise.resolve();
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new F(P.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = bs(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , $i(e.localStore, t) ];
...
function xu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Ru(t) ];
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = Q(t)).asyncQueue.verifyOperationInProgress(), U("RemoteStore", "RemoteStore received new credentials"), 
                                    i = ns(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Fr.add(3 /* CredentialChange */), [ 4 /*yield*/ , Yo(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Fr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Ho(n) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.onUnlisten = Gs.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function qu(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Cr;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new _u({
                            next: function(o) {
                                ...
                                i.reject(new F(P.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && o.fromCache && r && "server" === r.source ? i.reject(new F(P.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), s = new xs(oe(n.path), o, {
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new _u({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return Ds(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new F(P.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s, u) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = To.UNAUTHENTICATED, 
        ...
        var n = function(t) {
            U("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.auth.addAuthTokenListener(e.ac);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                U("FirebaseCredentialsProvider", "Auth not yet detected"), e.oc.resolve());
            }
        }), 0);
    }
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.cc !== e ? (U("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (z("string" == typeof n.accessToken), new Gu(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.uc = function() {
        ...
        return z(null === t || "string" == typeof t), new To(t);
    }, t;
}(), Hu = /** @class */ function() {
    function t(t, e, n) {
        this.hc = t, this.lc = e, this.fc = n, this.type = "FirstParty", this.user = To.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Hu(this.hc, this.lc, this.fc));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(To.FIRST_PARTY);
        }));
 ...
 */
function Xu(t, e, n) {
    if (!n) throw new F(P.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function $u(t) {
    if (!wt.isDocumentKey(t)) throw new F(P.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Ju(t) {
    if (wt.isDocumentKey(t)) throw new F(P.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Zu(t) {
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new F(P.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Zu(t);
        throw new F(P.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function ea(t, e) {
    if (e <= 0) throw new F(P.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var na = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new F(P.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new F(P.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new F(P.INVALID_ARGUMENT, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    function t(t, e) {
         ...
         */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new na({}), 
        this._settingsFrozen = !1, t instanceof ju ? (this._databaseId = t, this._credentials = new zu) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new F(P.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new ju(t.options.projectId);
        }(t), this._credentials = new Wu(e));
    }
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new F(P.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new F(P.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new na(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new zu;
            switch (t.type) {
              case "gapi":
                var e = t.client;
                ...
                new Yu(e, t.sessionIndex || "0", t.iamToken || null);

              case "provider":
                return t.client;

              default:
                throw new F(P.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Ku.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
 ...
 */ function ia(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        var s, u;
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, u = To.MOCK_USER; else {
            ...
            if (!a) throw new F(P.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            u = new To(a);
        }
        t._credentials = new Qu(new Gu(s, u));
    }
}
 ...
 */ var oa = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new ua(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, oe(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function aa(t, n) {
    ...
    if (t = b(t), Xu("collection", "path", n), t instanceof ra) {
        var o = it.fromString.apply(it, e([ n ], r));
        return Ju(o), new ua(t, /* converter= */ null, o);
    }
    if (!(t instanceof oa || t instanceof ua)) throw new F(P.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = it.fromString.apply(it, e([ t.path ], r)).child(it.fromString(n));
    return Ju(s), new ua(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function ca(t, e) {
    if (t = ta(t, ra), Xu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new F(P.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new sa(t, 
    /* converter= */ null, 
    /**
...
function ha(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = H.u()), Xu("doc", "path", n), t instanceof ra) {
        var o = it.fromString.apply(it, e([ n ], r));
        return $u(o), new oa(t, 
        /* converter= */ null, new wt(o));
    }
    if (!(t instanceof oa || t instanceof ua)) throw new F(P.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(it.fromString.apply(it, e([ n ], r)));
    return $u(s), new oa(t.firestore, t instanceof ua ? t.converter : null, new wt(s));
}
 ...
 * Firestore database.
 */ function fa(t, e) {
    return t = b(t), e = b(e), (t instanceof oa || t instanceof ua) && (e instanceof oa || e instanceof ua) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function la(t, e) {
    return t = b(t), e = b(e), t instanceof sa && e instanceof sa && t.firestore === e.firestore && pe(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var da = /** @class */ function() {
    function t() {
        ...
        this.Zi = new Bo(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Pc = function() {
        ...
        var e = this, n = this.dc.then((function() {
            return e.yc = !0, t().catch((function(t) {
                ...
                throw e.gc = t, e.yc = !1, B("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
        ...
        var i = ws.createAndSchedule(this, t, e, n, (function(t) {
            return r.bc(t);
        }));
...
var ya = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Cr, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
    ...
    function n(t, n) {
        ...
        /**
             * Whether it's a Firestore or Firestore Lite instance.
             */
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new da, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
...
function ga(t, e) {
    ...
    if (n.isInitialized()) {
        ...
        if (I(o, e)) return r;
        throw new F(P.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new F(P.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
...
function Ia(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Bu(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new ku(t._credentials, t._queue, r);
}
 ...
 */ function Ta(t, e) {
    Ra(t = ta(t, ma));
    var n = ba(t), r = t._freezeSettings(), i = new Eu;
    return Sa(n, i, new Iu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Ea(t) {
    Ra(t = ta(t, ma));
    var e = ba(t), n = t._freezeSettings(), r = new Eu;
    return Sa(e, r, new Tu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Cu(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , xu(t, e) ];
...
function _a(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new F(P.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new Cr;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Lr.gt() ? (e = t + "main", [ 4 /*yield*/ , Lr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Gi(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Da(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Fu(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = Q(t);
                            return e.Fr.delete(0 /* UserDisabled */), Ho(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (ba(t = ta(t, ma)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Fr.add(0 /* UserDisabled */), [ 4 /*yield*/ , Yo(e) ];
...
function Ca(t, e) {
    var i = ba(t = ta(t, ma)), o = new ya;
    return function(t, e, i, o) {
        var s = this, u = function(t, e) {
            return function(t, e) {
                return new Nu(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return Su(t, e);
                if (t instanceof ArrayBuffer) return Su(new Uint8Array(t), e);
...
function xa(t, e) {
    ...
    }(ba(t = ta(t, ma)), e).then((function(e) {
        return e ? new sa(t, null, e.query) : null;
    }));
}

function Ra(t) {
    if (t._initialized || t._terminated) throw new F(P.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var La = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new F(P.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var Pa = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new F(P.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new F(P.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new F(P.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
}(), Va = /^__.*__$/, qa = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Qe(t, this.data, this.fieldMask, e, this.fieldTransforms) : new ze(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Ua = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var ja = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.xc = function(e) {
        ...
        return ac(t, this.settings.methodName, this.settings.Bc || !1, this.path, this.settings.Uc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Ba(this.Nc) && Va.test(t)) throw this.Lc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ka = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || Uo(t)
 ...
 * classes.
 */ function Ga(t) {
    var e = t._freezeSettings(), n = Uo(t._databaseId);
    return new Ka(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function za(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.qc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ic("Data must be an object, but it was:", s, r);
    var u, a, c = nc(r, s);
    if (o.merge) u = new ut(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = oc(e, l[f], n);
            if (!s.contains(d)) throw new F(P.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            cc(h, d) || h.push(d);
        }
        u = new ut(h), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new qa(new Ot(c), u, a);
}
...
var Ha = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new Pe(t.path, new De);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Fa), Ya = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(Fa), $a = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).jc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Re(t.R, Te(t.R, this.jc));
...
/** Parse update data from an update() call. */ function Ja(t, e, n, r) {
    var i = t.qc(1 /* Update */ , e, n);
    ic("Data must be an object, but it was:", i, r);
    var o = [], s = Ot.empty();
    et(r, (function(t, r) {
        var u = uc(e, t, n);
    ...
    var u = new ut(o);
    return new Ua(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Za(t, e, n, r, i, o) {
    var s = t.qc(1 /* Update */ , e, n), u = [ oc(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new F(P.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(oc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Ot.empty(), l = u.length - 1; l >= 0; --l) if (!cc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = b(p);
    ...
    var m = new ut(h);
    return new Ua(f, m, s.fieldTransforms);
}
 ...
 */ function tc(t, e, n, r) {
    return void 0 === r && (r = !1), ec(n, t.qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ec(t, e) {
    ...
    // from firestore-exp.
    t = b(t))) return ic("Unsupported field value:", e, t), nc(t, e);
    if (t instanceof Fa) 
    ...
    return function(t, e) {
        ...
        if (!Ba(e.Nc)) throw e.Lc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof oa) {
            ...
            return {
                referenceValue: Pn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Lc("Unsupported field value: " + Zu(t));
    }(t, e);
}
...
function rc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof J || t instanceof Ma || t instanceof Pa || t instanceof oa || t instanceof Fa);
}
 ...
 */ function oc(t, e, n) {
    ...
    // FieldPath.
    (e = b(e)) instanceof La) return e._internalPath;
 ...
 * evaluated.
 */ function uc(t, n, r) {
    if (n.search(sc) >= 0) throw ac("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (La.bind.apply(La, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw ac("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
...
function ac(t, e, n, r, i) {
    ...
    a += ")"), new F(P.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var hc = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new fc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(lc("DocumentSnapshot.get", t));
 ...
 */
function lc(t, e) {
    return "string" == typeof e ? uc(t, e) : e instanceof La ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var dc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new yc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(lc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(hc), yc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new dc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new yc(n._firestore, n._userDataWriter, r.key, r, new dc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new F(P.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new yc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new dc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new yc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new dc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function gc(t, e) {
    return t instanceof pc && e instanceof pc ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof vc && e instanceof vc && t._firestore === e._firestore && la(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
 ...
 * limitations under the License.
 */ function wc(t) {
    if (ue(t) && 0 === t.explicitOrderBy.length) throw new F(P.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Tc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Ga(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new F(P.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Mc(s, o), 
            u = tc(n, "where", s, 
            ...
            return function(t, e) {
                if (e.g()) {
                    var n = ce(t);
                    if (null !== n && !n.isEqual(e.field)) throw new F(P.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ae(t);
                    null !== r && Vc(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new F(P.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new F(P.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
...
var Sc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new F(P.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new F(P.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Zt(e, n);
            return function(t, e) {
                if (null === ae(t)) {
...
var Nc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new sa(t.firestore, t.converter, de(t._query, this.Hc, this.Jc));
    }, n;
}(bc);
 ...
 * @returns The created `Query`.
 */ function Dc(t) {
    return ea("limit", t), new Nc("limit", t, "F" /* First */)
    /**
...
function Ac(t) {
    return ea("limitToLast", t), new Nc("limitToLast", t, "L" /* Last */);
}
...
var kc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Pc(t, this.type, this.Yc, this.Xc);
        return new sa(t.firestore, t.converter, function(t, e) {
...
function Cc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new kc("startAt", t, /*before=*/ !0);
}

function xc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new kc("startAfter", t, 
    /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Pc(t, e, n, r) {
    if (n[0] = b(n[0]), n[0] instanceof hc) return function(t, e, n, r, i) {
        if (!r) throw new F(P.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], s = 0, u = fe(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(Dt(e, r.key)); else {
                var c = r.data.field(a.field);
                if (dt(c)) throw new F(P.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new F(P.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Ga(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new F(P.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new F(P.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!he(t) && -1 !== c.indexOf("/")) throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(it.fromString(c));
                if (!wt.isDocumentKey(h)) throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new wt(h);
                u.push(Dt(e, f));
            } else {
                var l = tc(n, r, c);
...
function Fc(t, e, n) {
    if ("string" == typeof (n = b(n))) {
        if ("" === n) throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!he(e) && -1 !== n.indexOf("/")) throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(it.fromString(n));
        if (!wt.isDocumentKey(r)) throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Dt(t, new wt(r));
    }
    if (n instanceof oa) return Dt(t, n._key);
    throw new F(P.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Zu(n) + ".");
}
 ...
 * array requirements.
 */ function Mc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new F(P.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new F(P.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Vc(t, e, n) {
    if (!n.isEqual(e)) throw new F(P.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var qc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Ma(ft(t.latitude), ft(t.longitude));
        ...
        switch (e) {
          ...
          case "estimate":
            return this.convertTimestamp(yt(t));
        ...
        var n = it.fromString(t);
        z(sr(n));
        var r = new ju(n.get(1), n.get(3)), i = new wt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Bc = /** @class */ function(e) {
...
}(qc), jc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Ga(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Kc(t, this._firestore), i = Uc(r.converter, e, n), o = za(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Me.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Kc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof La ? Za(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Ja(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Me.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Kc(t, this._firestore);
        return this._mutations = this._mutations.concat(new Je(e._key, Me.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new F(P.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function Kc(t, e) {
    if ((t = b(t)).firestore !== e) throw new F(P.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Gc(t) {
    t = ta(t, oa);
    var e = ta(t.firestore, ma);
    return qu(ba(e), t._key).then((function(n) {
        return ih(e, t, n);
    }));
}
 ...
 */ function Qc(t) {
    t = ta(t, oa);
    var e = ta(t.firestore, ma), i = ba(e), o = new zc(e);
    return function(t, e) {
        var i = this, o = new Cr;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new F(P.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = bs(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new pc(e, o, t._key, n, new dc(null !== n && n.hasLocalMutations, 
 ...
 */ function Hc(t) {
    t = ta(t, sa);
    var e = ta(t.firestore, ma), n = ba(e), r = new zc(e);
    return wc(t._query), Uu(n, t._query).then((function(n) {
        return new vc(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , oo(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Vs(e, n.Bn), s = o._o(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = bs(a, "Failed to execute query '" + e + " against cache"), 
...
function $c(t, e, n) {
    t = ta(t, oa);
    var r = ta(t.firestore, ma), i = Uc(t.converter, e, n);
    return rh(r, [ za(Ga(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Me.none()) ]);
}

function Jc(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = ta(t, oa);
    var o = ta(t.firestore, ma), s = Ga(o);
    return rh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = b(e)) || e instanceof La ? Za(s, "updateDoc", t._key, e, n, r) : Ja(s, "updateDoc", t._key, e)).toMutation(t._key, Me.exists(!0)) ]);
}
 ...
 */ function Zc(t) {
    return rh(ta(t.firestore, ma), [ new Je(t._key, Me.none()) ]);
}
 ...
 */ function th(t, e) {
    var n = ta(t.firestore, ma), r = ha(t), i = Uc(t.converter, e);
    return rh(n, [ za(Ga(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Me.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function eh(t) {
    ...
    "object" != typeof s[c] || pa(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof oa) f = ta(t.firestore, ma), l = oe(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](ih(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = ta(t, sa);
        f = ta(y.firestore, ma), l = y._query;
        var v = new zc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new vc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, wc(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new _u(o), a = new xs(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function ih(t, e, n) {
    ...
    return new pc(t, i, e._key, r, new dc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var oh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Kc(t, this._firestore), i = new zc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new pc(n._firestore, i, r._key, t._document, new dc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Ga(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Kc(t, this._firestore), r = new Bc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return G();
            var i = t[0];
            if (i.isFoundDocument()) return new hc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new hc(e._firestore, r, n._key, null, n.converter);
            throw G();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Kc(t, this._firestore), i = Uc(r.converter, e, n), o = za(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof La ? Za(this._dataReader, "Transaction.update", s._key, e, n, r) : Ja(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Au(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
 ...
 * writes.
 */ function lh(t) {
    return ba(t = ta(t, ma)), new jc(t, (function(e) {
        return rh(t, e);
    }))
    /**
 * Cloud Firestore
...
L = u, a(new h("firestore-exp", (function(t, e) {
    var n = e.options, r = t.getProvider("app-exp").getImmediate(), i = new ma(r, t.getProvider("auth-internal"));
    return n = Object.assign({
        useFetchStreams: !0
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "2.4.0", undefined);

export { qc as AbstractUserDataWriter, Pa as Bytes, va as CACHE_SIZE_UNLIMITED, ua as CollectionReference, oa as DocumentReference, pc as DocumentSnapshot, La as FieldPath, Fa as FieldValue, ma as Firestore, F as FirestoreError, Ma as GeoPoint, ya as LoadBundleTask, sa as Query, bc as QueryConstraint, yc as QueryDocumentSnapshot, vc as QuerySnapshot, dc as SnapshotMetadata, J as Timestamp, oh as Transaction, jc as WriteBatch, th as addDoc, hh as arrayRemove, ch as arrayUnion, _a as clearIndexedDbPersistence, aa as collection, ca as collectionGroup, ia as connectFirestoreEmulator, Zc as deleteDoc, uh as deleteField, Aa as disableNetwork, ha as doc, Oa as documentId, Ta as enableIndexedDbPersistence, Ea as enableMultiTabIndexedDbPersistence, Da as enableNetwork, Oc as endAt, Lc as endBefore, ba as ensureFirestoreConfigured, rh as executeWrite, Gc as getDoc, Qc as getDocFromCache, Wc as getDocFromServer, Hc as getDocs, Yc as getDocsFromCache, Xc as getDocsFromServer, wa as getFirestore, fh as increment, ga as initializeFirestore, Dc as limit, Ac as limitToLast, Ca as loadBundle, xa as namedQuery, eh as onSnapshot, nh as onSnapshotsInSync, _c as orderBy, Ic as query, la as queryEqual, fa as refEqual, sh as runTransaction, ah as serverTimestamp, $c as setDoc, q as setLogLevel, gc as snapshotEqual, xc as startAfter, Cc as startAt, ka as terminate, Jc as updateDoc, Na as waitForPendingWrites, Ec as where, lh as writeBatch };
