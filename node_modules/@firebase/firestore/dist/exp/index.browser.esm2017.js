...
import { getUA as c, isSafari as a, isMobileCordova as u, isReactNative as h, isElectron as l, isIE as f, isUWP as d, isBrowserExtension as w, createMockUserToken as _, getModularInstance as m, __PRIVATE_deepEqual as g } from "@firebase/util";
 ...
 */ class _t {
    ...
    static fromPath(t) {
        return new _t(tt.fromString(t));
    }
    static fromName(t) {
        return new _t(tt.fromString(t).popFirst(5));
    }
...
/** Creates a deep copy of `source`. */ function St(t) {
    ...
    if (t.mapValue) {
        ...
        return Y(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = St(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class Nt {
     ...
     */    static newInvalidDocument(t) {
        return new Nt(t, 0 /* INVALID */ , H.min(), Dt.empty(), 0 /* SYNCED */);
    }
    /**
...
class Lt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Ut(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Qt(t, n) : "in" /* IN */ === e ? new Wt(t, n) : "not-in" /* NOT_IN */ === e ? new Gt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new zt(t, n) : new Lt(t, e, n);
    }
    static l(t, e, n) {
...
/** A Filter that implements the array-contains operator. */ class Qt extends Lt {
    constructor(t, e) {
 ...
 */ function ue(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Yt(t)), e.p.push(new Yt(nt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function he(t) {
    const e = q(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = kt(e.path, e.collectionGroup, ue(e), e.filters, e.limit, e.startAt, e.endAt); else {
...
function ke(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof be && e instanceof be || t instanceof Ve && e instanceof Ve ? W(t.elements, e.elements, gt) : t instanceof De && e instanceof De ? gt(t.A, e.A) : t instanceof Pe && e instanceof Pe;
...
function qe(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && W(t, e, ((t, e) => ke(t, e)));
 ...
 */ class yn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, pn.createSynthesizedTargetChangeForCurrentChange(t, e)), new yn(H.min(), n, gn(), un(), _n());
    }
}
...
class Rn {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (Mt(t)) if (0 === n) {
                ...
                this.tt(e, n, Nt.newNoDocument(n, H.min()));
            } else U(1 === n); else {
                this.ct(e) !== n && (
     ...
     */    at(t) {
        ...
        this.G.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Mt(i.target)) {
                    ...
                    null !== this.H.get(e) || this.ut(s, e) || this.tt(s, e, Nt.newNoDocument(e, t));
                }
                n.O && (e.set(s, n.M()), n.L());
            }
        }));
        ...
        return this.H = un(), this.J = Pn(), this.Y = new on(Q), s;
    }
    /**
...
function Ln(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? tt.emptyPath() : Un(e);
}
...
function Qn(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.I ? (U(void 0 === e || "string" == typeof e), it.fromBase64String(e || "")) : (U(void 0 === e || e instanceof Uint8Array), 
            it.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? C.UNKNOWN : en(t.code);
 ...
 */ (o);
        ...
        }), c = Nt.newFoundDocument(i, r, o), a = s.targetIds || [], u = s.removedTargetIds || [];
        n = new En(a, u, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Fn(t, s.document), r = s.readTime ? xn(s.readTime) : H.min(), o = Nt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new En([], c, o.key, o);
...
function Gn(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        let n = null;
        if ("setToServerValue" in e) U("REQUEST_TIME" === e.setToServerValue), n = new Pe; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new be(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Ve(t);
        } else "increment" in e ? n = new De(t, e.increment) : B();
...
function Yn(t) {
    ...
    let a = null;
    n.startAt && (a = es(n.startAt));
    let u = null;
    return n.endAt && (u = es(n.endAt)), ne(e, i, o, r, c, "F" /* First */ , a, u);
}
...
function Zn(t) {
    return t ? void 0 !== t.unaryFilter ? [ cs(t) ] : void 0 !== t.fieldFilter ? [ os(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Zn(t))).reduce(((t, e) => t.concat(e))) : B() : [];
}
 ...
 */ class ks {
    ...
    next(t, e) {
        return this.callbackAttached && B(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new ks(((n, s) => {
            this.nextCallback = e => {
 ...
 */ class Os {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Os._t(c()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return O("SimpleDb", "Removing database:", t), Us(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = c(), e = Os._t(t), n = 0 < e && e < 10, s = Os.Et(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async At(t) {
        return this.db || (O("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new N(C.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ms(t, s));
            }, s.onupgradeneeded = t => {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ms extends N {
    constructor(t, e) {
 ...
 */ class Ws {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && W(this.mutations, t.mutations, ((t, e) => qe(t, e))) && W(this.baseMutations, t.baseMutations, ((t, e) => qe(t, e)));
    }
}
...
function ni(t, e) {
    ...
    const s = e.mutations.map((e => Gn(t.Lt, e))), i = z.fromMillis(e.localWriteTimeMs);
    return new Ws(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function si(t) {
    const e = ei(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? ei(t.lastLimboFreeSnapshotVersion) : H.min();
    let s;
    var i;
 ...
 */ class hi {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new on(tt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new on(tt.comparator)).toArray();
    }
}
...
class gi {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            U("number" == typeof o);
            const c = new Ws(o, e, n, s), a = function(t, e, n) {
            ...
            for (const t of s) {
                ...
                h = h.add(t.key.path.popLast()), u.push(r.put(a)), u.push(i.put(e, ys.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return pi(t).get(e).next((t => t ? (U(t.userId === this.userId), ni(this.R, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return pi(t).Ot({
            ...
            e.userId === this.userId && (U(e.batchId >= n), i = ni(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return Ei(t).Ot({
            ...
            return pi(t).get(a).next((t => {
                if (!t) throw B();
                U(t.userId === this.userId), i.push(ni(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(pi(t).get(e).next((t => {
                if (null === t) throw B();
                U(t.userId === this.userId), n.push(ni(this.R, t));
            })));
        })), ks.waitFor(s).next((() => n));
    }
 ...
 */ class Ai {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Ri(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (U(e.targetCount > 0), 
    ...
    Xt(t) {
        return Pi(t).get(Ps.key).next((t => (U(null !== t), t)));
    }
    Zt(t, e) {
    ...
    containsKey(t, e) {
        const n = hs(e.path), s = IDBKeyRange.bound([ n ], [ G(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return bi(t).Ot({
 ...
 */ async function vi(t) {
    if (t.code !== C.FAILED_PRECONDITION || t.message !== Cs) throw t;
    ...
    ae(t) {
        ...
        O("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ls(t) ? O("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await vi(t);
            }
            await this.ae(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ci {
    ...
    collect(t, e) {
        ...
        ks.resolve(di)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (O("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        di) : this.fe(t, e)));
    }
    getCacheSize(t) {
 ...
 */ class Oi {
     ...
     */    Ee(t, e) {
        let n = un(), s = new nn(_t.comparator);
        return this.pe(t, e, ((t, e) => {
            const i = this.ge(t, e);
    ...
    getMetadata(t) {
        return Mi(t).get(Is.key).next((t => (U(!!t), t)));
    }
    me(t, e) {
    ...
    applyChanges(t) {
        ...
        return this.changes.forEach(((i, r) => {
            ...
            if (r.document.isValidDocument()) {
                ...
                const n = Ys(this.Ie.R, Nt.newNoDocument(i, H.min()), this.getReadTime(i));
...
class ji {
    ...
    u) {
        ...
        this.Me = t => Promise.resolve(), !ji.gt()) throw new N(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
     ...
     */    start() {
        ...
        return this.Qe().then((() => {
            ...
            throw new N(C.FAILED_PRECONDITION, Ki);
    ...
    Je(t) {
        return Qi(t).get(_s.key).next((t => ks.resolve(this.tn(t))));
    }
    en(t) {
    ...
    getMutationQueue(t) {
        return gi.jt(t, this.R, this.qt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Ue;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Ds, (s => (i = new js(s, this.Ne ? this.Ne.next() : D.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            ...
            this.Se.enqueueRetryable((() => this.Me(!1))), new N(C.FAILED_PRECONDITION, Cs);
            return n(i);
    ...
    // be turned off.
    dn(t) {
        return Qi(t).get(_s.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new N(C.FAILED_PRECONDITION, Ki);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = Qi(t);
        return e.get(_s.key).next((t => this.tn(t) ? (O("IndexedDbPersistence", "Releasing primary lease."), 
     ...
     */    Ge() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ke = () => {
            ...
            this.an(), a() && navigator.appVersion.match("Version/14") && 
 ...
 */ class Yi {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (ie(e) || re(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (k() <= p.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), we(e)), 
    ...
    Dn(t, e) {
        return k() <= p.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", we(e)), 
 ...
 */ function ar(t, e, n) {
    ...
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : H.min(), n ? r : _n()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
async function fr(t, e, n, s) {
    ...
    const a = i.Fn.newChangeBuffer({
        trackRemovals: !0
    }), u = await or(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return he(se(tt.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => ir(t, a, o, H.min(), c).next((e => (a.apply(t), 
...
async function dr(t, e, n = _n()) {
    ...
    const s = await or(t, he(ri(e.bundledQuery))), i = q(t);
 ...
 */ class _r {
     ...
     * removed.
     */    Zn(t) {
        const e = new _t(new tt([])), n = new mr(e, t), s = new mr(e, t + 1), i = [];
    ...
    es(t) {
        const e = new _t(new tt([])), n = new mr(e, t), s = new mr(e, t + 1);
        let i = _n();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class Vr {
     ...
     */    static Vs(t, e, n) {
        ...
        r && (i = new N(s.error.code, s.error.message))), r ? new Vr(t, e, s.state, i) : (F("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ss() {
        const t = {
...
class Sr {
     ...
     */    static Vs(t, e) {
        ...
        i && (s = new N(n.error.code, n.error.message))), i ? new Sr(t, n.state, s) : (F("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Dr {
     ...
     */    static Vs(t, e) {
        ...
        return s ? new Dr(t, i) : (F("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Cr {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Cr(e.clientId, e.onlineState) : (F("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
...
class {
    ...
    Fi(t, e) {
        ...
        // on a closed stream
                const m = new Mr({
            Ei: t => {
                _ ? O("Connection", "Not sending because WebChannel is closed:", t) : (a || (O("Connection", "Opening WebChannel transport."), 
 ...
 */ class Qr extends jr {
    ...
    onMessage(t) {
        ...
        const e = Qn(this.R, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? H.min() : e.readTime ? xn(e.readTime) : H.min();
        }(t);
     ...
     */    mr(t) {
        ...
        e.database = Bn(this.R), e.addTarget = function(t, e) {
            ...
            return n = Mt(s) ? {
                ...
                query: Jn(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Cn(t, e.resumeToken) : e.snapshotVersion.compareTo(H.min()) > 0 && (
    ...
    e, n, s, i) {
        ...
        this.Mr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                io(this) && (O("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */
        ...
        O("RemoteStore", "Failed to raise snapshot:", e), await uo(t, e);
    }
}
 ...
 */ function Ao(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await lo(t)) : (await t.Kr.stop(), t.$r.length > 0 && (O("RemoteStore", `Stopping write stream with ${t.$r.length} pending writes`), 
        t.$r = []));
    }))), t.Kr;
}
 ...
 */ function Po(t, e) {
    if (F("AsyncQueue", `${e}: ${t}`), Ls(t)) return new N(C.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Ko {
     ...
     */    _o(t, e) {
        ...
        if (t.inorderTraversal(((t, e) => {
            const u = s.get(t), h = _e(this.query, e) ? e : null, l = !!u && this.mutatedKeys.has(u.key), f = !!h && (h.hasLocalMutations || 
 ...
 */ (t.type, e.type) || this.lo(t.doc, e.doc))), this.po(n);
    ...
    // PORTING NOTE: Multi-tab only.
    Ro() {
        return Vo.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }
}
 ...
 */ async function zo(t, e, n, s) {
    ...
    /* usePreviousResults= */ !0), r = new Ko(e, i.Bn), o = r._o(i.documents), c = pn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.applyChanges(o, 
 ...
 */ async function Jo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = q(t), s = z.now(), i = e.reduce(((t, e) => t.add(e.key)), _n());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Qe(t.key, e, Ct(e.value.mapValue), Oe.exists(!0)));
                }
 ...
 */ async function Zo(t, e, n) {
    ...
    if (r) {
        ...
        t = t.insert(r, Nt.newNoDocument(r, H.min()));
        const n = _n().add(r), i = new yn(H.min(), 
 ...
 */ async function nc(t, e) {
    const n = q(t);
    io(n.remoteStore) || O("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function oc(t, e) {
    ...
    const n = t.Do.get(e);
    null !== n && (Zr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), uc(t));
}

function cc(t, e, n) {
    for (const s of n) if (s instanceof Uo) t.No.addReference(s.key, e), ac(t, s); else if (s instanceof qo) {
 ...
 */ function uc(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new _t(tt.fromString(e)), s = t.$o.next();
        t.Co.set(s, new Qo(n)), t.Do = t.Do.insert(n, s), Xr(t.remoteStore, new zs(he(se(n.path)), s, 2 /* LimboResolution */ , D.o));
    }
}
...
async function _c(t, e, n, s) {
    const i = q(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Qt(t, e).next((e => e ? n.Mn.pn(t, e) : ks.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Tc(t, e, n) {
    ...
    if (s.Oo) {
        for (const t of e) {
            ...
            const e = await ur(s.localStore, t), n = await or(s.localStore, e);
 ...
 */ class bc extends Pc {
    ...
    async initialize(t) {
        await super.initialize(t), await lr(this.localStore), await this.jo.initialize(this, t), 
        // Enqueue writes from a previous session
        await Ac(this.jo.syncEngine), await lo(this.jo.remoteStore), 
    ...
    Uo(t) {
        ...
        return new ji(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Br(), Ur(), this.R, this.sharedClientState, !!this.forceOwnership);
    }
    Bo(t) {
        return new kr;
    }
 ...
 */ class vc extends bc {
    ...
    async initialize(t) {
        ...
        await this.persistence.He((async t => {
            await mc(this.jo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = Br();
        if (!xr.gt(e)) throw new N(C.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Vc {
    ...
    terminate() {
        return async function(t) {
            const e = q(t);
            O("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), await Yr(e), 
            e.Lr.shutdown(), 
...
class Nc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = q(t), s = Bn(n.R) + "/documents", i = {
...
/** Enables the network connection and re-enqueues all pending operations. */ function jc(t) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Dc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => No(t, o))), n.fromCache && "server" === s.source ? i.reject(new N(C.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Oo(n, r, {
            includeMetadataChanges: !0,
...
class ea {
    ...
    isEqual(t) {
        return t instanceof ea && t.projectId === this.projectId && t.database === this.database;
    }
}
...
/** A CredentialsProvider that always yields an empty token. */ class ia {
    constructor() {
        /**
...
class oa {
    constructor(t) {
        ...
        const e = t => {
            O("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.auth.addAuthTokenListener(this.ac);
        };
        t.onInit((t => e(t))), 
    ...
    getToken() {
        ...
        this.getToken()) : e ? (U("string" == typeof e.accessToken), new sa(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    ...
    uc() {
        ...
        return U(null === t || "string" == typeof t), new Rr(t);
    }
}
 ...
 */ class aa {
    ...
    getToken() {
        return Promise.resolve(new ca(this.hc, this.lc, this.fc));
    }
    setChangeListener(t, e) {
 ...
 */
function ha(t) {
    if (!_t.isDocumentKey(t)) throw new N(C.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function la(t) {
    if (_t.isDocumentKey(t)) throw new N(C.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ class ma {
    ...
    constructor(t, e) {
         ...
         */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new _a({}), 
        this._settingsFrozen = !1, t instanceof ea ? (this._databaseId = t, this._credentials = new ia) : (this._app = t, 
 ...
 */ (t), this._credentials = new oa(e));
    ...
    _setSettings(t) {
        ...
        this._settings = new _a(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new ia;
            switch (t.type) {
              case "gapi":
                const e = t.client;
                ...
                new aa(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
        return function(t) {
            const e = na.get(t);
            e && (O("ComponentProvider", "Removing Datastore"), na.delete(t), e.terminate());
...
function ga(t, e, n, s = {}) {
    var i;
    const r = (t = da(t, ma))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        let e, n;
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = Rr.MOCK_USER; else {
        ...
        t._credentials = new ra(new sa(e, n));
    }
}
...
function Ta(t, e, ...n) {
    if (t = m(t), ua("collection", "path", e), t instanceof ma) {
        const s = tt.fromString(e, ...n);
        return la(s), new Ea(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof ya || t instanceof Ea)) throw new N(C.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = tt.fromString(t.path, ...n).child(tt.fromString(e));
        return la(s), new Ea(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Ia(t, e) {
    if (t = da(t, ma), ua("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new N(C.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new pa(t, 
    /* converter= */ null, 
    /**
...
function Aa(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = j.u()), ua("doc", "path", e), t instanceof ma) {
        const s = tt.fromString(e, ...n);
        return ha(s), new ya(t, 
        /* converter= */ null, new _t(s));
    }
    {
        if (!(t instanceof ya || t instanceof Ea)) throw new N(C.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(tt.fromString(e, ...n));
        return ha(s), new ya(t.firestore, t instanceof Ea ? t.converter : null, new _t(s));
    }
}
 ...
 * Firestore database.
 */ function Ra(t, e) {
    return t = m(t), e = m(e), (t instanceof ya || t instanceof Ea) && (e instanceof ya || e instanceof Ea) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Pa(t, e) {
    return t = m(t), e = m(e), t instanceof pa && e instanceof pa && (t.firestore === e.firestore && fe(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Ro.createAndSchedule(this, t, e, n, (t => this.bc(t)));
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ const Sa = -1;
...
class Da extends ma {
    ...
    constructor(t, e) {
         ...
         * Whether it's a Firestore or Firestore Lite instance.
         */
        this.type = "firestore", this._queue = new ba, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
...
function ka(t) {
    ...
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new ta(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
 ...
 */ function $a(t, e) {
    Qa(t = da(t, Da));
    const n = xa(t), s = t._freezeSettings(), i = new Vc;
    return Fa(n, i, new bc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Oa(t) {
    Qa(t = da(t, Da));
    const e = xa(t), n = t._freezeSettings(), s = new Vc;
    return Fa(e, s, new vc(s, n.cacheSizeBytes));
}
 ...
 */ function ja(t, e) {
    return Zc(xa(t = da(t, Da)), e).then((e => e ? new pa(t, null, e.query) : null));
}
 ...
 */ class za {
     ...
     */    static fromBase64String(t) {
        try {
            return new za(it.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new za(it.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Xa {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new Qe(t, this.data, this.fieldMask, e, this.fieldTransforms) : new je(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Za {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class eu {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    xc(t) {
        return new eu(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    kc(t) {
        var e;
    ...
    Lc(t) {
        return Tu(t, this.settings.methodName, this.settings.Bc || !1, this.path, this.settings.Uc);
    }
    ...
    Oc(t) {
        ...
        if (tu(this.Nc) && Ya.test(t)) throw this.Lc('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function iu(t, e, n, s, i, r = {}) {
    const o = t.qc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    gu("Data must be an object, but it was:", o, s);
    const c = _u(s, o);
    let a, u;
    if (r.merge) a = new st(o.fieldMask), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        ...
        a = new st(t), u = o.fieldTransforms.filter((t => a.covers(t.field)));
    } else a = null, u = o.fieldTransforms;
    return new Xa(new Dt(c), a, u);
}
...
class au extends Ha {
    ...
    _toFieldTransform(t) {
        const e = ou(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => wu(t, e))), s = new be(n);
...
class uu extends Ha {
    ...
    _toFieldTransform(t) {
        const e = ou(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => wu(t, e))), s = new Ve(n);
        return new xe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** Parse update data from an update() call. */ function lu(t, e, n, s) {
    ...
    const c = new st(r);
    return new Za(o, c, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function fu(t, e, n, s, i, r) {
    ...
    for (let t = c.length - 1; t >= 0; --t) if (!Iu(u, c[t])) {
        const e = c[t];
        let n = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const l = new st(u);
    return new Za(h, l, o.fieldTransforms);
}
 ...
 */ function wu(t, e) {
    ...
    // from firestore-exp.
    t = m(t))) return gu("Unsupported field value:", e, t), _u(t, e);
    if (t instanceof Ha) 
 ...
 */
    return function(t, e) {
        ...
        if (!tu(e.Nc)) throw e.Lc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Lc(`Unsupported field value: ${fa(t)}`);
    }
    /**
...
function mu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof z || t instanceof Ja || t instanceof za || t instanceof ya || t instanceof Ha);
}
 ...
 */ function yu(t, e, n) {
    ...
    // FieldPath.
    e = m(e)) instanceof Wa) return e._internalPath;
 ...
 * evaluated.
 */ function Eu(t, e, n) {
    if (e.search(pu) >= 0) throw Tu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Wa(...e.split("."))._internalPath;
    } catch (s) {
...
function Tu(t, e, n, s, i) {
    ...
    a += ")"), new N(C.INVALID_ARGUMENT, c + t + a);
}
 ...
 */ class Au {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Ru(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Pu("DocumentSnapshot.get", t));
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function Pu(t, e) {
    return "string" == typeof e ? Eu(t, e) : e instanceof Wa ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class vu extends Au {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new Vu(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Pu("DocumentSnapshot.get", t));
 ...
 */ class Su {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new bu(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Vu(this._firestore, this._userDataWriter, n.key, n, new bu(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Vu(t._firestore, t._userDataWriter, n.doc.key, n.doc, new bu(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Vu(t._firestore, t._userDataWriter, e.doc.key, e.doc, new bu(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function Nu(t) {
    if (re(t) && 0 === t.explicitOrderBy.length) throw new N(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class $u extends xu {
    ...
    _apply(t) {
        const e = su(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.isKeyField()) {
...
class Lu extends xu {
    ...
    _apply(t) {
        return new pa(t.firestore, t.converter, le(t._query, this.Hc, this.Jc));
    }
}
 ...
 * @returns The created `Query`.
 */ function Bu(t) {
    return wa("limit", t), new Lu("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function Uu(t) {
    return wa("limitToLast", t), new Lu("limitToLast", t, "L" /* Last */);
}
...
/** Helper function to create a bound from a document or fields */ function zu(t, e, n, s) {
    if (n[0] = m(n[0]), n[0] instanceof Au) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of ue(t)) if (n.field.isKeyField()) r.push(At(e, s.key)); else {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    if ("string" != typeof a) throw new N(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`);
                    if (!ae(t) && -1 !== a.indexOf("/")) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(tt.fromString(a));
                    if (!_t.isDocumentKey(n)) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new _t(n);
                    c.push(At(e, i));
                } else {
                    const t = du(n, s, a);
...
function Hu(t, e, n) {
    if ("string" == typeof (n = m(n))) {
        ...
        if (!_t.isDocumentKey(s)) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return At(t, new _t(s));
    }
    if (n instanceof ya) return At(t, n._key);
    throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${fa(n)}.`);
}
 ...
 */ class Xu {
    ...
    convertGeoPoint(t) {
        return new Ja(ct(t.latitude), ct(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        U(us(n));
        const s = new ea(n.get(1), n.get(3)), i = new _t(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class eh {
    ...
    constructor(t, e) {
        ...
        this._dataReader = su(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const s = nh(t, this._firestore), i = Zu(s.converter, e, n), r = iu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = m(e)) || e instanceof Wa ? fu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : lu(this._dataReader, "WriteBatch.update", i._key, e), 
...
function sh(t) {
    t = da(t, ya);
    const e = da(t.firestore, Da);
    return Gc(xa(e), t._key).then((n => gh(e, t, n)));
}
 ...
 */ function rh(t) {
    t = da(t, ya);
    const e = da(t.firestore, Da), n = xa(e), s = new ih(e);
    return Wc(n, t._key).then((n => new vu(e, s, t._key, n, new bu(null !== n && n.hasLocalMutations, 
 ...
 */ function ch(t) {
    t = da(t, pa);
    const e = da(t.firestore, Da), n = xa(e), s = new ih(e);
    return Nu(t._query), Hc(n, t._query).then((n => new Su(e, s, t, n)));
}
 ...
 */ function ah(t) {
    t = da(t, pa);
    const e = da(t.firestore, Da), n = xa(e), s = new ih(e);
    return zc(n, t._query).then((n => new Su(e, s, t, n)));
}
...
function hh(t, e, n) {
    t = da(t, ya);
    const s = da(t.firestore, Da), i = Zu(t.converter, e, n);
    return mh(s, [ iu(su(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Oe.none()) ]);
}

function lh(t, e, n, ...s) {
    t = da(t, ya);
    const i = da(t.firestore, Da), r = su(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = m(e)) || e instanceof Wa ? fu(r, "updateDoc", t._key, e, n, s) : lu(r, "updateDoc", t._key, e);
 ...
 */ function fh(t) {
    return mh(da(t.firestore, Da), [ new He(t._key, Oe.none()) ]);
}
 ...
 */ function dh(t, e) {
    const n = da(t.firestore, Da), s = Aa(t), i = Zu(t.converter, e);
    return mh(n, [ iu(su(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Oe.exists(!1)) ]).then((() => s));
}
...
function wh(t, ...e) {
    ...
    "object" != typeof e[o] || va(e[o]) || (r = e[o], o++);
    const c = {
    ...
    let a, u, h;
    if (t instanceof ya) u = da(t.firestore, Da), h = se(t._key.path), a = {
        next: n => {
            e[o] && e[o](gh(u, t, n));
        },
        error: e[o + 1],
        ...
        const n = da(t, pa);
        u = da(n.firestore, Da), h = n._query;
        const s = new ih(u);
        a = {
            next: t => {
 ...
 */ function gh(t, e, n) {
    ...
    return new vu(t, i, e._key, s, new bu(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class yh extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = su(t);
    }
    /**
     ...
     */    get(t) {
        ...
        return this._transaction.lookup([ e._key ]).then((t => {
            ...
            const s = t[0];
            if (s.isFoundDocument()) return new Au(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Au(this._firestore, n, e._key, null, e.converter);
            throw B();
        }));
    }
    set(t, e, n) {
        const s = nh(t, this._firestore), i = Zu(s.converter, e, n), r = iu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = m(e)) || e instanceof Wa ? fu(this._dataReader, "Transaction.update", i._key, e, n, s) : lu(this._dataReader, "Transaction.update", i._key, e), 
     ...
     */    get(t) {
        ...
        return super.get(t).then((t => new vu(this._firestore, n, e._key, t._document, new bu(
        /* hasPendingWrites= */ !1, 
 ...
 * writes.
 */ function Ph(t) {
    return xa(t = da(t, Da)), new eh(t, (e => mh(t, e)));
}
...
!function(t) {
    ...
    const n = t.getProvider("app-exp").getImmediate(), s = new Da(n, t.getProvider("auth-internal"));
    return e = Object.assign({
        useFetchStreams: !0
    }, e), s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), i("@firebase/firestore", "2.4.0", bh);
