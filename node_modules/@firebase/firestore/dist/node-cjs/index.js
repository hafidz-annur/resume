...
var FieldPath = /** @class */ (function () {
    ...
    FieldPath.documentId = function () {
         ...
         * effect is the same.
         */
        return new FieldPath(databaseB718dabb.FieldPath$1.keyField().canonicalString());
    };
...
function registerFirestore(instance) {
    configureForFirebase(instance, function (app, auth) { return new databaseB718dabb.Firestore(app, new databaseB718dabb.Firestore$1(app, auth), new databaseB718dabb.IndexedDbPersistenceProvider()); });
